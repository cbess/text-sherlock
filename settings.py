...
# True if the target path will be indexed
# recursively (includes sub directories).
# type: boolean
# default: True
...
# Allows the indexer to ignore errors produced during file indexing. For
# example: any unicode or file read errors, it will skip indexing those files.
